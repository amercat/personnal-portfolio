        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#skills" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('skills')}>Talents</Nav.Link>
            ...
            <span className="navbar-text">
              ...
              <HashLink to='#connect'>
                <button className="vvd"><span>Découvrez mes talents</span></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
